...
Route::prefix('administrative')->middleware(['auth', 'is.admin'])->group(function () {
...
Route::prefix('simulation')->middleware(['auth'])->group(function () {
...
Route::prefix('userSimulation')->middleware(['auth'])->group(function () {
...
Route::prefix('redaction')->middleware(['auth'])->group(function () {
