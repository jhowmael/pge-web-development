...
<body style="height: 100%; margin: 0;">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        @if($user)
                        @if($user->premium === 1)
                        <li class="nav-item"><a class="btn fw-bold" href="{{ route('welcome') }}">Área do Estudante</a></li>
                        @else
                        <li class="nav-item"><a class="btn fw-bold" href="{{ route('plans') }}">Seja Premium</a></li>
                        @endif
                        @else
                        <li class="nav-item"><a class="btn fw-bold" href="{{ route('plans') }}">Seja Premium</a></li>
                        @endif
                        ...
                        @guest
                        <li class="nav-item"><a class="btn fw-bold" href="{{ route('login') }}">Login</a></li>
                        <li class="nav-item"><a class="btn fw-bold" href="{{ route('register') }}">Registrar</a></li>
                        @else
                        <li class="nav-item dropdown">
                            <a class="nav-link fw-bold dropdown-toggle d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{ route('plans') }}">Minha assinatura</a></li>
                                <li>
    ...
    <script>
        ...
        // Verifica cor do fundo para navbar
        window.addEventListener('DOMContentLoaded', function() {
            ...
            function checkBackgroundColor() {
                ...
                if (parseInt(rgb[0]) > 200 && parseInt(rgb[1]) > 200 && parseInt(rgb[2]) > 200) {
