    ...
    <div class="side-top">
        <div class="container">
            ...
            <div class="text-center mt-5">
                <h3 class="fw-bold text-white" data-aos="fade-right" data-aos-delay="30">Seja bem-vindo ao AproveME!</h3>
                <p class="lead text-muted; text-white" data-aos="fade-right" data-aos-delay="30">Estamos aqui para ajudá-lo a alcançar o sucesso nos vestibulares com um plano de estudo personalizado e apoio especializado.</p>
            </div>

            <div class="row align-items-center flex-column-reverse flex-md-row">
                <!-- Coluna de Texto -->
                <div class="col-md-6 text-center text-md-start">
                    <div class="bg-light p-4 rounded-4 shadow-lg position-relative overflow-hidden" data-aos="fade-up" data-aos-delay="30">
                        <div class="text-center mt-5">
    ...
    <div class="container">
        ...
        <div class="py-5">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                @foreach ([
                ['Metodologia Eficaz', 'Nossa metodologia personalizada garante um aprendizado eficiente e adaptado ao seu ritmo. Ela considera suas dificuldades, pontos fortes e estilo de estudo para potencializar seus resultados.'],
                ['Inteligência Artificial para Redação', 'A IA analisa sua redação com precisão, oferecendo sugestões para melhorar seu desempenho. Com isso, você desenvolve textos mais coerentes, coesos e alinhados aos critérios dos avaliadores.'],
                ['Material Exclusivo', 'Estude com conteúdos atualizados, pensados para os principais vestibulares do país. Cada material é elaborado por especialistas para facilitar sua compreensão e fixação do conteúdo.'],
                ['Simulados Realistas', 'Treine com simulados que reproduzem a estrutura e nível das provas oficiais. Ao se familiarizar com o ambiente do vestibular, você ganha confiança e aprende a gerenciar melhor o tempo.'],
                ['Análise Pessoal', 'Receba relatórios completos com dados sobre seu desempenho e pontos de melhoria. Isso permite um planejamento mais estratégico, com foco em resultados concretos e evolução constante.'],
                ['Mentoria Personalizada', 'Tenha acompanhamento individual com mentores que orientam sua jornada de estudos. Eles ajudam na organização da rotina, motivam e ajustam o caminho conforme seu progresso.']
                ] as $item)
                <div class="col">
