        ...
        <div class="col-md-7 right-panel">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="input-group mb-4">
                    ...
                    <input type="email" class="form-control custom-email-box w-75" name="email" placeholder="Email">
                </div>
                ...
                <div class="input-group mb-4">
                    ...
                    <input type="password" class="form-control custom-password-box" name="password" placeholder="Senha">
                </div>
